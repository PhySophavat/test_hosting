...
@section('content')
<div class="w-full p-8 bg-white rounded-lg shadow-lg mt-10">
    <h1 class="text-2xl font-bold mb-6 text-gray-800 border-b-2 border-blue-600 pb-3">កែប្រែព័ត៌មានគ្រូ</h1>
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <input type="password" name="password" placeholder="បញ្ចូលពាក្យសម្ងាត់ថ្មី" 
                           class="border border-gray-300 rounded-lg p-3 w-full focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    <small class="text-gray-500 text-sm">ទទេបញ្ជាក់ថាមិនប្ដូរពាក្យសម្ងាត់</small>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="gender" class="border border-gray-300 rounded-lg p-3 w-full focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        ...
                        <option value="ប្រុស" {{ old('gender', $teacher->gender) == 'ប្រុស' ? 'selected' : '' }}>ប្រុស</option>
                        <option value="ស្រី" {{ old('gender', $teacher->gender) == 'ស្រី' ? 'selected' : '' }}>ស្រី</option>
                    </select>
                </div>

                <div>
                    <label class="block font-medium mb-2 text-gray-700">គ្រប់គ្រងថ្នាក់</label>
                    <input type="text" name="class_assigned" value="{{ old('class_assigned', $teacher->class_assigned) }}" 
                           class="border border-gray-300 rounded-lg p-3 w-full focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-2">
                        <input type="text" name="village" value="{{ old('village', $teacher->village) }}" placeholder="ភូមិ" class="border border-gray-300 rounded-lg p-3 w-full focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        <input type="text" name="commune" value="{{ old('commune', $teacher->commune) }}" placeholder="ឃុំ/សង្កាត់" class="border border-gray-300 rounded-lg p-3 w-full focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        <input type="text" name="district" value="{{ old('district', $teacher->district) }}" placeholder="ស្រុក/ខណ្ឌ" class="border border-gray-300 rounded-lg p-3 w-full focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        <input type="text" name="province" value="{{ old('province', $teacher->province) }}" placeholder="ខេត្ត/រាជធានី" class="border border-gray-300 rounded-lg p-3 w-full focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    </div>
                </div>
